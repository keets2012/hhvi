...
public abstract class ValueIteration extends PolicyStrategy{
	...
	public ValueIteration( POMDP pomdp ){
		...
		initValueFunctionUsingBlindPolicy();  //初始化下界
	...
	protected Pair<Double, Double> CalculateADRConvergence( POMDP pomdp,  Pair<Double,Double> pComputedADRs ){
